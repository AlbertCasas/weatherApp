<template>
    <div class="additional-info container">
        <div>
            <span>Sunrise</span>
            <span>{{new Date(this.currentWeather.sys.sunrise * 1000).toLocaleString("en-uk", {timeStyle: "short"})}}</span>
        </div>
        <div>
            <span>Sunset</span>
            <span>{{new Date(this.currentWeather.sys.sunset * 1000).toLocaleString("en-uk", {timeStyle: "short"})}}</span>
        </div>
        <div>
            <span>Humidity</span>
